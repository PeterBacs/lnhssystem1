                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page"><a
                                href="{{ route('notice-board.index') }}">{{ ___('common.notice board') }}</a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <label for="exampleDataList"
                                        class="form-label ">{{ ___('common.attachment') }} {{ ___('common.(690 x 460 px)') }}<span
                                            class="fillable"></span></label>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="input-check-radio academic-section @error('sections') is-invalid @enderror">
                                        ...
                                        <div class="form-check">
                                          <input class="form-check-input" type="checkbox" name="visible_to[]" value="{{ $item->id }}" {{in_array($item->id, $data['notice-board']->visible_to) ? 'checked':''}}  id="flexCheckDefault-1" />
