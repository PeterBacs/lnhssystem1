                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-12 col-md-6 col-xl-6 col-lg-6 mb-3 _common_div">
                                ...
                                <input type="text" name="aws_access_key_id"
                                    ...
                                    value="{{ env('APP_DEMO') ? '': setting('aws_access_key_id') }}" placeholder="{{ ___('settings.aws_access_key_id') }}">
                        ...
                        <div class="col-12 col-md-6 col-xl-6 col-lg-6 mb-3 _common_div">
                                ...
                                <input type="text" name="aws_secret_key"
                                    ...
                                    value="{{ env('APP_DEMO') ? '': setting('aws_secret_key') }}" placeholder="{{ ___('settings.aws_secret_key') }}">
