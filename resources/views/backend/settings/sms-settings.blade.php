                                ...
                                <div class="row mb-3">
                                    <div class="col-12 col-md-6 col-xl-6 col-lg-6 mb-3">
                                        ...
                                        <input type="text" name="twilio_account_sid"
                                            ...
                                            value="{{ env('APP_DEMO') ? '': Setting('twilio_account_sid') }}" placeholder="{{ ___('settings.twilio_account_sid') }}">
                                    ...
                                    <div class="col-12 col-md-6 col-xl-6 col-lg-6 mb-3">
                                        ...
                                        <input type="text" name="twilio_auth_token"
                                            ...
                                            value="{{ env('APP_DEMO') ? '': Setting('twilio_auth_token') }}" placeholder="{{ ___('settings.twilio_auth_token') }}">
                                    ...
                                    <div class="col-12 col-md-6 col-xl-6 col-lg-6 mb-3">
                                        ...
                                        <input type="text" name="twilio_phone_number"
                                            ...
                                            value="{{ env('APP_DEMO') ? '': Setting('twilio_phone_number') }}" placeholder="{{ ___('settings.twilio_phone_number') }}">
                                        {{-- value="{{ $data['data']->where('name', 'recaptcha_secret')->pluck('value')->first() }} --}}
