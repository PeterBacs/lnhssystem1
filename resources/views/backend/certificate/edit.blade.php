                            ...
                            <div class="col-xl-7">
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        <label for="exampleDataList" class="form-label ">{{ ___('common.Certificate Title') }} <span class="fillable">*</span></label>
                                    ...
                                    <div class="col-md-12">
                                        <label for="exampleDataList" class="form-label ">{{ ___('common.Background Image') }}<span class="fillable"></span></label>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <label for="exampleDataList" class="form-label ">{{ ___('common.Certificate Visibility') }} <span class="fillable"></span></label>
