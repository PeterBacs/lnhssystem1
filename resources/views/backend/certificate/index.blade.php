        ...
        <div class="table-content table-basic mt-20">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    @if (hasPermission('certificate_create'))
                        <a href="{{ route('certificate.create') }}" class="btn btn-lg ot-btn-primary">
                        ...
                        <table class="table table-bordered role-table">
                            <thead class="thead">
                                <tr>
                                    ...
                                    @if (hasPermission('certificate_update') || hasPermission('certificate_delete'))
                                        <th class="action">{{ ___('common.action') }}</th>
                                    @endif
                                </tr>
                            </thead>
                            <tbody class="tbody">
                                @forelse ($data['certificates'] ?? [] as $key => $row)
                                <tr id="row_{{ $row->id }}">
                                    ...
                                    <td>
                                        ...
                                        {{ ___('common.logo') }}: 
                                            ...
                                            <input class="toggle-checkbox" type="checkbox" name="logo" {{$row->logo == true ? 'checked':''}}  id="toggle1">
                                        ...
                                        <input class="toggle-checkbox" type="checkbox" name="name" {{$row->name == true ? 'checked':''}}  id="toggle2">
                                    ...
                                    <td>
                                        <a class="btn btn-sm ot-btn-primary"
                                                            ...
                                                            data-bs-target="#openCertificatePreviewModal" onclick="openCertificatePreviewModal({{$row->id}})"><span
                                                                class="icon mr-8"><i
                                        ...
                                        <td class="action">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end ">
                                                    @if (hasPermission('certificate_update'))
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ route('certificate.edit', $row->id) }}"><span
                                                                    class="icon mr-8"><i
                                                                        class="fa-solid fa-pen-to-square"></i></span>
                                                                {{ ___('common.edit') }}</a>
                                                        </li>
                                                    @endif
                                                    @if (hasPermission('certificate_delete'))
                                                        <li>
                                                            <a class="dropdown-item" href="javascript:void(0);"
                                                                onclick="delete_row('certificate/delete', {{ $row->id }})">
                        ...
                        <div class="ot-pagination pagination-content d-flex justify-content-end align-content-center py-3">
                            <nav aria-label="Page navigation example">
                                <ul class="pagination justify-content-between">
                                    {!!$data['certificates']->appends(\Request::capture()->except('page'))->links() !!}
                                </ul>
                            </nav>
                        </div>
