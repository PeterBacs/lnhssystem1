                            ...
                            <div class="col-xl-7">
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        <label for="exampleDataList" class="form-label ">{{ ___('common.ID Card Title') }} <span class="fillable">*</span></label>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <label for="exampleDataList" class="form-label ">{{ ___('common.expired date') }} <span
                                    ...
                                    <div class="col-md-6">
                                        <label for="exampleDataList" class="form-label ">{{ ___('common.Frontside Background Image') }}<span class="fillable"></span></label>
                                    ...
                                    <div class="col-md-6">
                                        <label for="exampleDataList" class="form-label ">{{ ___('common.backside Background Image') }}<span class="fillable"></span></label>
                                        <div class="ot_fileUploader left-side mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <label for="exampleDataList" class="form-label ">{{ ___('common.QR Code') }}<span class="fillable"></span></label>
                                        <div class="ot_fileUploader left-side mb-3">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <label for="exampleDataList" class="form-label ">{{ ___('common.backside description') }}</label>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <label for="exampleDataList" class="form-label ">{{ ___('common.ID Card Visibility') }} <span class="fillable"></span></label>
